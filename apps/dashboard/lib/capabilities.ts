...
/**
 * Every tool an agent connected to Pocket can call.
 *
...
export const CAPABILITIES: readonly Capability[] = [
  ...
  {
    tool: 'pocket_create_task_budget',
...
/** One thing a vendor does that Pocket could not do without it. */
